...
struct EMTFUnpTrackInfo {
  ...
  std::vector<TString> vInt = {{"unp_trk_pt_int", "unp_trk_eta_int", "unp_trk_theta_int", "unp_trk_phi_int", "unp_trk_BX","unp_trk_endcap", 
				...
				"unp_trk_dR_match_iReco", "unp_trk_dR_match_nReco", "unp_trk_dR_match_nRecoSoft", "unp_trk_dR_match_unique",
				"unp_trk_emu_match_iTrk", "unp_trk_emu_match_dBX", "unp_trk_emu_match_unique", "unp_trk_emu_match_exact"}};
